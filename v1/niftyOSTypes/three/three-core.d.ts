...
export class Object3D extends EventDispatcher {
     ...
     */
    onBeforeRender: (renderer: THREE_CLASSIC.WebGLRenderer, scene: THREE_CLASSIC.Scene, camera: THREE_CLASSIC.Camera, geometry: THREE_CLASSIC.Geometry | THREE_CLASSIC.BufferGeometry,
                     material: THREE_CLASSIC.Material, group: THREE_CLASSIC.Group) => void;

    /**
     * Calls after rendering object
     */
    onAfterRender: (renderer: THREE_CLASSIC.WebGLRenderer, scene: THREE_CLASSIC.Scene, camera: THREE_CLASSIC.Camera, geometry: THREE_CLASSIC.Geometry | THREE_CLASSIC.BufferGeometry,
                    material: THREE_CLASSIC.Material, group: THREE_CLASSIC.Group) => void;
